...
function buildDemoTree() {
  ...
  return [
    ...
    { id: 'P1.1.1', name: 'Define requirements', status: 'done', best: 5, factor: 1.3, prio: 2, deps: [], softDeps: [], assign: ['M1'], team: 'T1', customValues: { jira: 'DEMO-1' } },
    { id: 'P1.1.2', name: 'Design core UI', status: 'done', best: 8, factor: 1.4, prio: 2, deps: ['P1.1.1'], softDeps: [], assign: ['M2'], team: 'T1', customValues: { jira: 'DEMO-2' } },
    ...
    { id: 'P2.1', name: 'Profile the bottleneck', status: 'done', best: 3, factor: 1.3, prio: 2, deps: [], softDeps: [], assign: ['M1'], team: 'T2' },
    ...
    { id: 'D1', name: 'Compliance audit Q3', type: 'deadline', severity: 'critical', date: relDate(90), status: 'open', best: 0, factor: 1.5, prio: 1, deps: [], softDeps: [], assign: [], team: '', description: 'External audit — must pass before Sep 30.' },
    ...
    { id: 'D1.4', name: 'Audit sign-off', status: 'open', best: 2, factor: 1.3, prio: 1, deps: ['D1.3'], softDeps: [], assign: ['M3'], team: 'T2', decideBy: relDate(60) },
...
export function buildDemoProject(t) {
  ...
  return {
    ...
    members: [
      ...
      // 60 % when a parental leave kicks in 45 days from now, back to
      // 100 % three months later. Scheduler resolves the active cap per
      // task start week automatically.
      { id: 'M1', name: 'Alex Kim',   team: 'T2', cap: 1, vac: 25,
        capChanges: [
          { from: relDate(45), cap: 0.6 },
          { from: relDate(135), cap: 1.0 },
        ],
      },
