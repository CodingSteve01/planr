...
const en = {
  ...
  'ex.jiraSync': 'Jira reconcile',
  'ex.jiraSync.desc': 'Find the drift between plan and board: status, renames, missing tickets. Paste a Jira table, accept the statuses.',
  ...
  'q.mirrorTip': 'Shared task — primary lane: {0}',
  'q.modePersons': 'Per person', 'q.modeProjects': 'Per project',
  'q.projectsEmpty': 'No projects match the current filters.',
  'q.depConflict': 'dep later in queue',
  'q.depConflictTip': 'Depends on {0} which is queued after this task — scheduler will swap them.',
  'q.schedPosTip': 'Scheduler position: #{0}',
  'q.queueCount': 'queues',
  ...
  'js.card': 'Jira reconcile',
  'js.cardDesc': 'Find the drift between plan and board: status, renames, missing tickets.',
...
const de = {
  ...
  'ex.jiraSync': 'Jira-Abgleich',
  'ex.jiraSync.desc': 'Drift zwischen Plan und Board finden: Status, Umbenennungen, fehlende Tickets. Jira-Tabelle einfügen, Status übernehmen.',
  'ex.sprint': 'Sprint (Markdown)',
  ...
  'q.mirrorTip': 'Geteilte Aufgabe — Primary-Lane: {0}',
  'q.modePersons': 'Pro Person', 'q.modeProjects': 'Pro Projekt',
  'q.projectsEmpty': 'Keine Projekte im aktuellen Filter.',
  'q.depConflict': 'Dep weiter unten',
  'q.depConflictTip': 'Abhängig von {0}, das aber später in der Queue steht — Scheduler tauscht beide.',
  'q.schedPosTip': 'Scheduler-Position: #{0}',
  'q.queueCount': 'Queues',
  ...
  'js.card': 'Jira-Abgleich',
  'js.cardDesc': 'Drift zwischen Plan und Board finden: Status, Umbenennungen, fehlende Tickets.',
