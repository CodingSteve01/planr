...
const en = {
  ...
  'nm.dropHint': 'Leaves both sides of every fraction: not delivered, not outstanding, no capacity, no dates. Everything below it goes with it. The status it has is kept. · 0',
...
const de = {
  ...
  'nm.dropHint': 'Verlässt beide Seiten jedes Bruchs: nicht geliefert, nicht offen, keine Kapazität, keine Termine. Alles darunter geht mit. Der Status bleibt erhalten. · 0',
