...
const en = {
  ...
  'bd.help': 'While this is on, every status, progress and completion you record counts as of the chosen date instead of today. Use it to catch up at the end of a sprint on work that was actually finished at its start — the next review then shows it on the day it happened.',
...
const de = {
  ...
  'bd.help': 'Solange das an ist, zählt jede Status-, Fortschritts- und Erledigt-Änderung zum gewählten Datum statt zu heute. Gedacht zum Nachtragen am Sprint-Ende von Arbeit, die schon zu Sprint-Beginn fertig war — im nächsten Review steht sie dann an dem Tag, an dem sie passiert ist.',
  'bd.date': 'Wirksam zum',
