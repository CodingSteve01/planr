...
const en = {
  ...
  'wo.blockedTip': 'Waits for work that is not delivered yet:',
  'wo.blockedLaterTip': 'This order cannot happen — it waits for something further down this list:',
  ...
  'ex.whatwhen.desc': 'One row per topic. Exact dates near term, weeks, months or quarters further out.',
  ...
  'report.title': 'Report',
  'report.desc': 'Every export from the Export dialog, as a screen you can scroll through.',
  ...
  'qe.affectsDeadlineInheritedOff': 'A parent item is already excluded from this deadline, so this one is too.',
  ...
  'qe.tab.overview': 'Details', 'qe.tab.workflow': 'Status', 'qe.tab.estimate': 'Estimate', 'qe.tab.schedule': 'Plan', 'qe.tab.deps': 'Dependencies', 'qe.tab.effort': 'Estimate', 'qe.tab.timing': 'Schedule',
  ...
  'ng.tooBigTitle': '{0} items is more graph than a screen can show',
  'ng.tooBigBody': 'A dependency graph stays readable up to about a hundred nodes. Pick a project or use the scope filter — every other view narrows with it.',
  'ng.tooBigAnyway': 'Draw all of it anyway',
  ...
  'g.compact': 'Compact', 'g.compactOn': 'Rows', 'g.compactOff': 'Rows',
  'g.compactTip': 'Packs each group\u2019s bars into as few lanes as they need. A lane holds several tasks, so names are on the bars rather than in the left column.',
  'g.classicTip': 'One row per task, named in the left column. On a large plan this gets tall and mostly empty.',
  'g.loadHeatmap': 'Load', 'g.loadHeatmapTip': 'A solid line under a bar is that week\u2019s load (blue under, green healthy, amber full, red over); a hatched one is time off. Resource group rows carry the week-by-week strip.',
  ...
  'g.reorderUpTip': 'Move the selection one place earlier among its siblings — the same move as ⌥↑ on the row in the tree.',
  'g.reorderDownTip': 'Move the selection one place later among its siblings — the same move as ⌥↓ on the row in the tree.',
  ...
  'g.vacation': 'Vacation', 'g.holiday': 'Public holiday',
  'tv.movesSelection': '{0} rows — moves take all of them', 'tv.movesSelectionTip': 'Up/down, indent and outdent move the whole selection as a block, keeping its order. Dragging a selected row drags the selection.',
  ...
  's.progressCaption': 'effort-weighted across {0} PT',
  's.kpiDelivered': 'Delivered', 's.kpiOpen': 'Outstanding', 's.kpiItems': 'Tasks done',
  's.kpiEnd': 'Projected end', 's.kpiScope': 'Scope', 's.kpiDropped': 'Dropped',
  's.planLabel': 'Plan · in the horizon',
  ...
  'set.uiScaleHelp': 'Scales text, icons and rows together. Useful in a narrow pane or on a high-resolution screen.',
  ...
  'chip.hideDone': 'Done',
  'chip.hideDoneTip': 'Hide what is finished — completed and dropped',
  'chip.auto': 'Auto',
  ...
  'rm.noDates': 'no dates yet', 'rm.dropped': 'dropped',
  'rm.stateDone': 'done',
  ...
  // ── Jira reconcile ──
  'ji.title': 'Import from Jira',
  'ob.jiraImport': 'Import from Jira instead',
  'ji.lead': 'Paste a Jira export — Export → CSV (all fields) — or a copied search result. The hierarchy, status, priority, estimate and assignee come across; the ticket key lands on each item, so reconciliation works from day one.',
  'ji.pasteLabel': 'Jira issues',
  'ji.parsed': '{0} tickets recognised · {1} skipped',
  'ji.nothing': 'Nothing recognisable yet. The paste needs a column with Jira keys (NA-385).',
  'ji.groupLabel': 'Put everything under one project',
  'ji.groupHint': 'Off: every epic — and every ticket without a parent — becomes its own project.',
  'ji.projectName': 'Project name',
  'ji.createMembers': 'Create the {0} people this paste names and nobody on the plan matches',
  'ji.createMembers1': 'Create the one person this paste names and nobody on the plan matches',
  'ji.createMembersOff': 'Their tasks stay unassigned; the schedule will suggest somebody.',
  'ji.unmatched': 'No match on the plan: {0}',
  'ji.preview': 'Preview',
  'ji.previewMore': '…and {0} more',
  'ji.submit': 'Import {0} items',
  'ji.appendHint': 'Added to the plan you have open, as {0} new project(s).',
  'ji.newPlanHint': 'This creates the plan. Teams, sizes and risks come from the standard template and can be changed afterwards.',
  'ji.noEstimates': '{0} of them arrive without an estimate — the schedule cannot place those until they have one.',
  ...
  'pr.conflicts': 'Contradicting entries',
  'pr.conflictsHelp': 'Items whose state contradicts itself or the tree around them. The filters hide most of them, while the queue and the schedule still count them. Click one to open and correct it.',
  'pr.conflictOrphan': 'parent {0} is missing',
  'pr.conflictDroppedLive': 'dropped, but {0}% done and in progress',
  'pr.conflictDoneOverOpen': 'done, but {0} open below: {1}',
  ...
  'rv.loadSortBy': 'Sort by', 'rv.loadSortOverload': 'Overload', 'rv.loadSortTeam': 'Team', 'rv.loadSortName': 'Name',
  ...
  'rv.teams': 'Teams', 'rv.addTeam': 'Add team...', 'rv.primaryTeam': 'Primary team — avatar colour and default for new tasks',
  'rv.teamShareFrom': '(from tasks)', 'rv.teamShareTip': 'Realised split of this person\'s scheduled effort by task team. Derived from the plan, not an input — it changes as tasks move.',
  ...
  'tv.dragTip': 'Drag the row: onto the top or bottom edge of a row to put {0} before or after it, onto the middle of a package to put it inside',
  'tv.dragRows': '{0} rows',
  ...
  'sc.editFields': 'Move through the row: name → team → priority → size → status',
  ...
  'km.scope.order': 'Work order — cursor on a row',
  'km.scope.gantt': 'Gantt',
  'km.scope.dialog': 'Item dialog',
  ...
  'sc.fullEdit': 'Open the full editor for this row',
  'sc.drop': 'Drop from the plan / take it back',
  'g.group.projectTip': 'The plan, as it is structured. Alt+Up/Down moves an item in the tree — the order the schedule follows.',
  'g.group.teamTip': 'What each team is carrying, and when.',
  'g.group.resourceTip': 'One row per person: their own order of work. The only place a task can be pulled ahead of another project\u2019s.',
  ...
  'rv.workOrderHelp': 'Each person\u2019s tasks in scheduled order. ⌥↑ / ⌥↓ moves a task one place, ⌥⇧↑ / ⌥⇧↓ to either end — the same keys as in the tree. Reordering here can pull a task ahead of another project\u2019s; dependencies and pinned dates still take precedence.',
  'rv.workOrderEmpty': 'Nobody has two or more tasks assigned yet — an order needs something to order.',
  'g.queueSorted': 'own order',
  'g.queueSortedTip': 'This person works through their tasks in an order you set, not the plan order. It moves only their own work — dependencies and pinned dates still win.',
  'g.queueReset': 'Back to the plan order',
  'tv.dropped': 'Dropped — not going to happen. Out of every count and off the schedule; the status it had is kept.',
  'nm.derivedStatus': 'A package has no status of its own — it follows the {1} tasks under it, {0} of them done. Change one of those, and this changes with it.',
  'nm.dropLabel': 'Not going to happen',
  'nm.dropDo': 'Drop from the plan', 'nm.dropUndo': 'Take it back',
  'nm.dropHint': 'Leaves both sides of every fraction: not delivered, not outstanding, no capacity, no dates. Everything below it goes with it. The status it has is kept.',
  'app.countDropped': '{0} dropped',
  'bd.command': 'Work as of an earlier date…',
  'palette.group.jobs': 'Jobs',
  'job.jira': 'Reconcile with Jira…',
  'job.vacation': 'Book a holiday…',
  'job.onboard': 'Take somebody on…',
  'bd.title': 'Changes count as of',
  'bd.help': 'While this is on, every status, progress and completion you record counts as of the chosen date instead of today. Use it to catch up at the end of a sprint on work that was actually finished at its start. Later entries for the same item that contradict what you record are removed, so the history does not walk done → wip → done.',
  'bd.date': 'Effective date',
  'bd.reset': 'Stays on until you switch it off, and resets when Planr reloads.',
  'bd.apply': 'Backdate from now on',
  'bd.clear': 'Stop backdating',
  'bd.chipTip': 'Everything you change counts as of {0}. Click × to stop.',
  'sc.newChild': 'New child, ready to type',
  'sc.indent': 'Indent: last child of the sibling above it on screen',
  'sc.outdent': 'Outdent: one level out, right after its old parent',
  'sc.moveUp': 'Move up among its siblings — never out of its branch',
  'sc.moveDown': 'Move down among its siblings — never out of its branch',
  'sc.cursorEnds': 'First / last row on screen',
  ...
  'sc.editNext': 'Save the row — on a row you just added, open the next one',
  'sc.editNextRow': 'Save the row and open a new one below',
  'sc.newRow': 'New row below, ready to type',
  ...
  'sc.ganttCursor': 'Move the cursor between bars',
  'sc.ganttOpen': 'Open the item under the cursor',
  'sc.ganttReorder': 'Move the item earlier / later',
  'sc.ganttReorderEnds': 'Move it first / last among its siblings',
  'sc.ganttSelectAll': 'Select every visible bar',
  'sc.ganttClear': 'Clear the selection, cancel a drag',
  'sc.orderEnds': 'First / last row of this person\u2019s queue', 'sc.orderMove': 'Move earlier / later in the queue (the whole selection)', 'sc.orderMoveEnds': 'Move to the front / end of the queue', 'sc.orderClear': 'Clear the selection', 'sc.orderSelectAll': 'Select this person\u2019s whole queue',
  'sc.dialogTab': 'Switch to tab 1–7, from anywhere in the dialog', 'sc.dialogTabBar': 'Previous / next tab (on the tab bar; Home / End for the ends)', 'sc.dialogSections': 'Walk the Insights sections and links; Enter opens the one in focus', 'sc.dialogSave': 'Save and close', 'sc.dialogClose': 'Close (asks first when something changed)',
  'tv.clickToRename': 'Click to rename (or press Enter)',
  'tv.unnamed': 'Unnamed — click to name it',
  'tv.editRowTip': 'Open {0} in the editor',
  'tv.editItem': 'Edit',
  'tv.rename': 'Rename',
  'tv.editSave': 'Save row',
  'tv.editCancel': 'Discard changes',
  ...
  'ob.feat.tree.htip': '**Work Tree**\nHierarchical work breakdown with **nested items, dependencies, and multi-person assignments**.\nDrag to reorder, shift-click for range select, right-click for context actions.',
  'ob.feat.auto.htip': '**Auto-schedule**\nPlanr runs a **person-level parallel scheduler** — each person works their queue in priority order, respecting capacity and vacations.\nNo manual date entry needed: change estimates or priorities and the schedule updates instantly.',
  'ob.feat.metro.htip': '**Metro Roadmap**\nEach project becomes a **subway line**. Milestones are stations, the train shows real-time progress along the route.\nHover stations for dates and status — a one-glance status page for stakeholders.',
  'ob.feat.horizons.htip': '**3 Planning Horizons**\n**H1 Committed** · work starting soon, fully defined.\n**H2 Estimated** · coming up, roughly scoped.\n**H3 Exploratory** · further out, intentionally lightweight.',
  'ob.feat.cp.htip': '**Critical Path**\nPlanr runs **CPM analysis** across the entire work tree and highlights the chain of tasks that directly controls your end date.\nRed bars = critical path. Shorten them or add people to accelerate the project.',
  'ob.feat.net.htip': '**Network Graph**\nA **zoomable, pannable dependency map** of your entire project.\nClick a node to edit, drag from the edge handle to create dependencies. Filtered by the same root / team / person selectors as other views.',
  'ob.feat.focus.htip': '**Focus Areas**\nLink **goals, painpoints, and deadlines** to work items for top-down planning.\nThe Overview tab shows which focus areas are at risk and how much work is linked to each objective.',
  'ob.feat.offboard': 'Offboard Cascade', 'ob.feat.offboard.desc': 'Auto-handoff when a person leaves mid-task',
  'ob.feat.offboard.htip': '**Offboard Cascade**\nScheduler detects a resource end-date mid-task and automatically hands off the remaining work to the next-free team member — optionally cross-team. Every leg (offcut) becomes its own Gantt row, and the handoff plan is manually overridable per leg.',
  'ob.feat.cap': 'Transparent Capacity', 'ob.feat.cap.desc': 'Weekly hours minus meetings — per FTE',
  'ob.feat.cap.htip': '**Transparent Capacity**\nCap is derived from weekly hours minus recurring meetings (daily/weekly/biweekly/monthly). Team meeting-plans inherit to every member — manual or derived. Every minute is auditable.',
  'ob.feat.export': 'Exec-ready Exports', 'ob.feat.export.desc': 'PDF + DOCX with subway map, critical path, risks',
  'ob.feat.export.htip': '**Shareable PDFs + DOCX**\nManagement summary as a true vector PDF with KPIs, subway roadmap, critical path, team capacity, risk list. Plus: Gantt PDF (high-DPI), what-comes-when (horizon-aware), TODO sprint per person, Word export for Confluence import.',
  'ob.feat.offline': 'Offline + File-mount', 'ob.feat.offline.desc': 'No backend, no login, full control',
  'ob.feat.offline.htip': '**Local & offline**\nAll data lives locally or in a mounted .md/.json file. File System Access API → no copy-paste workflow, automatic saving. No cloud dependency.',
  ...
  'app.save.autoToggleOn': 'Auto-save is ON — writes to disk {0}s after the last change. Use the save button to write now.',
  'app.save.autoToggleOff': 'Auto-save is OFF — changes only land in localStorage. Use the save button or Ctrl+S to write to the file.',
  ...
  'app.save.pillAutoOff': 'Auto-save is off. Use the save button or Ctrl/Cmd+S to write to the file.',
  ...
  'app.save.pillPending': 'Changes are safe in localStorage and will be written to the file {0}s after your last edit. Press Ctrl/Cmd+S or use the save button to write now.',
  ...
  // ── Tour steps ──
  'tour.s0.icon': 'subtask', 'tour.s0.title': 'Work Tree',
  ...
  'tour.s1.icon': 'calendar', 'tour.s1.title': 'Auto-schedule',
  ...
  'tour.s2.icon': 'plus', 'tour.s2.title': 'Add your first task',
  ...
  'tour.s3.icon': 'gantt', 'tour.s3.title': 'Track progress',
...
const de = {
  ...
  'wo.blockedTip': 'Wartet auf noch nicht geliefertes:',
  'wo.blockedLaterTip': 'Diese Reihenfolge geht nicht auf — wartet auf etwas weiter unten in dieser Liste:',
  ...
  'ex.whatwhen.desc': 'Eine Zeile je Thema. Kurzfristig exakte Daten, weiter weg Wochen, Monate oder Quartale.',
  'ex.todo': 'TODO / Sprint',
  ...
  'report.desc': 'Alle Exporte aus dem Export-Dialog, als scrollbarer Screen.',
  ...
  'qe.affectsDeadlineInheritedOff': 'Ein übergeordnetes Item ist bereits von dieser Deadline ausgenommen, dieses damit auch.',
  ...
  'qe.leafItems': 'Leaf-Items', 'qe.autoStatus': '(auto)',
  'qe.tab.overview': 'Details', 'qe.tab.workflow': 'Status', 'qe.tab.estimate': 'Schätzung', 'qe.tab.schedule': 'Planung', 'qe.tab.deps': 'Abhängigkeiten', 'qe.tab.effort': 'Schätzung', 'qe.tab.timing': 'Zeitplan',
  ...
  'ng.tooBigTitle': '{0} Items sind mehr Netz, als ein Bildschirm zeigen kann',
  'ng.tooBigBody': 'Ein Abhängigkeitsnetz bleibt bis etwa hundert Knoten lesbar. Wähle ein Projekt oder nimm den Ausschnitt-Filter — alle anderen Ansichten grenzen mit ein.',
  'ng.tooBigAnyway': 'Trotzdem alles zeichnen',
  ...
  'g.compact': 'Kompakt', 'g.compactOn': 'Zeilen', 'g.compactOff': 'Zeilen',
  'g.compactTip': 'Packt die Balken jeder Gruppe in so wenige Spuren, wie sie brauchen. Eine Spur trägt mehrere Aufgaben, die Namen stehen deshalb auf den Balken statt in der linken Spalte.',
  'g.classicTip': 'Eine Zeile je Aufgabe, benannt in der linken Spalte. Bei großen Plänen wird das sehr hoch und überwiegend leer.',
  'g.loadHeatmap': 'Last', 'g.loadHeatmapTip': 'Eine durchgezogene Linie unter einem Balken ist die Wochenlast (blau unterlastet, grün gesund, gelb voll, rot überlastet), eine schraffierte ist Abwesenheit. Ressourcen-Gruppenzeilen tragen den Wochenstreifen.',
  ...
  'g.reorderUpTip': 'Auswahl einen Platz weiter nach vorne — derselbe Zug wie ⌥↑ auf der Zeile im Tree.',
  'g.reorderDownTip': 'Auswahl einen Platz weiter nach hinten — derselbe Zug wie ⌥↓ auf der Zeile im Tree.',
  ...
  'g.vacation': 'Urlaub', 'g.holiday': 'Feiertag',
  'tv.movesSelection': '{0} Zeilen — Verschieben nimmt alle mit', 'tv.movesSelectionTip': 'Hoch/runter, Einrücken und Ausrücken bewegen die ganze Auswahl als Block, in ihrer Reihenfolge. Eine ausgewählte Zeile ziehen zieht die Auswahl mit.',
  ...
  's.progressCaption': 'aufwandsgewichtet über {0} PT',
  's.kpiDelivered': 'Geliefert', 's.kpiOpen': 'Offen', 's.kpiItems': 'Aufgaben erledigt',
  's.kpiEnd': 'Prognost. Ende', 's.kpiScope': 'Umfang', 's.kpiDropped': 'Verworfen',
  's.planLabel': 'Plan · im Horizont',
  ...
  'set.uiScaleHelp': 'Skaliert Text, Symbole und Zeilen gemeinsam. Nützlich in einem schmalen Pane oder auf einem hochauflösenden Bildschirm.',
  ...
  'chip.hideDoneTip': 'Abgeschlossenes ausblenden — erledigt und verworfen',
  'chip.auto': 'Auto',
  ...
  'rm.deadlineShort': 'Deadline',
  'rm.noDates': 'noch keine Termine', 'rm.dropped': 'verworfen',
  ...
  // ── Jira-Abgleich ──
  'ji.title': 'Aus Jira importieren',
  'ob.jiraImport': 'Stattdessen aus Jira importieren',
  'ji.lead': 'Einen Jira-Export einfügen — Export → CSV (alle Felder) — oder ein kopiertes Suchergebnis. Hierarchie, Status, Priorität, Schätzung und Zuständigkeit kommen mit; der Ticket-Key landet an jedem Item, damit der Abgleich ab dem ersten Tag funktioniert.',
  'ji.pasteLabel': 'Jira-Vorgänge',
  'ji.parsed': '{0} Tickets erkannt · {1} übersprungen',
  'ji.nothing': 'Noch nichts Erkennbares. Der Text braucht eine Spalte mit Jira-Keys (NA-385).',
  'ji.groupLabel': 'Alles unter einem Projekt zusammenfassen',
  'ji.groupHint': 'Aus: Jedes Epic — und jedes Ticket ohne übergeordneten Vorgang — wird ein eigenes Projekt.',
  'ji.projectName': 'Projektname',
  'ji.createMembers': 'Die {0} Personen anlegen, die hier vorkommen und zu niemandem im Plan passen',
  'ji.createMembers1': 'Die Person anlegen, die hier vorkommt und zu niemandem im Plan passt',
  'ji.createMembersOff': 'Ihre Aufgaben bleiben ohne Zuständigkeit; die Planung schlägt jemanden vor.',
  'ji.unmatched': 'Kein Treffer im Plan: {0}',
  'ji.preview': 'Vorschau',
  'ji.previewMore': '…und {0} weitere',
  'ji.submit': '{0} Items importieren',
  'ji.appendHint': 'Wird dem geöffneten Plan hinzugefügt, als {0} neue(s) Projekt(e).',
  'ji.newPlanHint': 'Damit entsteht der Plan. Teams, Größen und Risiken kommen aus der Standardvorlage und lassen sich danach ändern.',
  'ji.noEstimates': '{0} davon kommen ohne Schätzung — die kann die Planung erst einsortieren, wenn sie eine haben.',
  ...
  'pr.conflicts': 'Widersprüchliche Einträge',
  'pr.conflictsHelp': 'Einträge, deren Zustand sich selbst oder dem Baum drumherum widerspricht. Die Filter blenden die meisten aus, Queue und Zeitplan zählen sie aber weiter. Klick öffnet den Eintrag zum Korrigieren.',
  'pr.conflictOrphan': 'Parent {0} fehlt',
  'pr.conflictDroppedLive': 'verworfen, aber {0} % erledigt und in Arbeit',
  'pr.conflictDoneOverOpen': 'erledigt, aber {0} offen darunter: {1}',
  ...
  'rv.loadSortBy': 'Sortierung', 'rv.loadSortOverload': 'Überlast', 'rv.loadSortTeam': 'Team', 'rv.loadSortName': 'Name',
  ...
  'rv.teams': 'Teams', 'rv.addTeam': 'Team hinzufügen...', 'rv.primaryTeam': 'Hauptteam — Avatarfarbe und Vorgabe für neue Aufgaben',
  'rv.teamShareFrom': '(aus Aufgaben)', 'rv.teamShareTip': 'Tatsächliche Aufteilung des geplanten Aufwands dieser Person nach Team der Aufgabe. Ergibt sich aus dem Plan, keine Eingabe — ändert sich, wenn Aufgaben wandern.',
  ...
  'tv.dragTip': 'Zeile ziehen: an die obere oder untere Kante einer Zeile, um {0} davor oder dahinter zu setzen, in die Mitte eines Pakets, um es hineinzulegen',
  'tv.dragRows': '{0} Zeilen',
  ...
  'sc.editFields': 'Durch die Zeile: Name → Team → Priorität → Größe → Status',
  ...
  'km.scope.order': 'Reihenfolge — Cursor auf einer Zeile',
  'km.scope.gantt': 'Gantt',
  'km.scope.dialog': 'Eintrags-Dialog',
  ...
  'sc.findNext': 'Nächster / vorheriger Treffer (Zeitplan, Netzwerk)',
  ...
  'sc.selectAll': 'Alle Zeilen auf dem Schirm auswählen',
  ...
  'sc.fullEdit': 'Den vollständigen Editor für diese Zeile öffnen',
  'sc.drop': 'Aus dem Plan nehmen / zurückholen',
  'nm.derivedStatus': 'Ein Paket hat keinen eigenen Status — es folgt den {1} Aufgaben darunter, davon {0} erledigt. Ändere eine davon, und das hier ändert sich mit.',
  'nm.dropLabel': 'Wird nicht passieren',
  'nm.dropDo': 'Aus dem Plan nehmen', 'nm.dropUndo': 'Zurückholen',
  'nm.dropHint': 'Verlässt beide Seiten jedes Bruchs: nicht geliefert, nicht offen, keine Kapazität, keine Termine. Alles darunter geht mit. Der Status bleibt erhalten.',
  'g.group.projectTip': 'Der Plan, so wie er strukturiert ist. Alt+Hoch/Runter verschiebt einen Eintrag im Tree — das ist die Reihenfolge, der der Zeitplan folgt.',
  'g.group.teamTip': 'Was jedes Team trägt, und wann.',
  'g.group.resourceTip': 'Eine Zeile pro Person: ihre eigene Reihenfolge. Der einzige Ort, an dem eine Aufgabe vor die eines anderen Projekts gezogen werden kann.',
  ...
  'rv.workOrderHelp': 'Die Aufgaben jeder Person in geplanter Reihenfolge. ⌥↑ / ⌥↓ verschiebt eine Aufgabe um einen Platz, ⌥⇧↑ / ⌥⇧↓ ganz nach vorne oder hinten — dieselben Tasten wie im Tree. Umsortieren kann eine Aufgabe vor die eines anderen Projekts ziehen; Abhängigkeiten und feste Termine gehen weiterhin vor.',
  'rv.workOrderEmpty': 'Noch hat niemand zwei oder mehr Aufgaben zugewiesen — eine Reihenfolge braucht etwas zu ordnen.',
  'g.queueSorted': 'eigene Reihenfolge',
  'g.queueSortedTip': 'Diese Person arbeitet ihre Aufgaben in einer Reihenfolge ab, die du gesetzt hast — nicht in der Plan-Reihenfolge. Es verschiebt nur ihre eigene Arbeit; Abhängigkeiten und feste Termine gehen weiterhin vor.',
  'g.queueReset': 'Zurück zur Plan-Reihenfolge',
  'tv.dropped': 'Verworfen — wird nicht gemacht. Zählt nirgends mehr mit und wird nicht eingeplant; der Status bleibt erhalten.',
  'app.countDropped': '{0} verworfen',
  'bd.command': 'An einem früheren Datum arbeiten…',
  'palette.group.jobs': 'Aufgaben',
  'job.jira': 'Mit Jira abgleichen…',
  'job.vacation': 'Urlaub eintragen…',
  'job.onboard': 'Person aufnehmen…',
  'bd.title': 'Änderungen wirksam zum',
  'bd.help': 'Solange das an ist, zählt jede Status-, Fortschritts- und Erledigt-Änderung zum gewählten Datum statt zu heute. Gedacht zum Nachtragen am Sprint-Ende von Arbeit, die schon zu Sprint-Beginn fertig war. Spätere Einträge zum selben Item, die dem widersprechen, werden entfernt — sonst liefe die Historie erledigt → in Arbeit → erledigt.',
  'bd.date': 'Wirksam zum',
  'bd.reset': 'Bleibt an, bis du es ausschaltest, und setzt sich beim Neuladen zurück.',
  'bd.apply': 'Ab jetzt rückdatieren',
  'bd.clear': 'Rückdatierung beenden',
  'bd.chipTip': 'Alles, was du änderst, zählt zum {0}. Zum Beenden auf × klicken.',
  'sc.newChild': 'Neuer Unterpunkt, direkt tippbereit',
  'sc.indent': 'Einrücken: letztes Kind des Geschwisters darüber (des sichtbaren)',
  'sc.outdent': 'Ausrücken: eine Ebene heraus, direkt hinter das bisherige Elternteil',
  'sc.moveUp': 'Unter den Geschwistern nach oben — nie aus dem Zweig heraus',
  'sc.moveDown': 'Unter den Geschwistern nach unten — nie aus dem Zweig heraus',
  'sc.cursorEnds': 'Erste / letzte Zeile auf dem Schirm',
  ...
  'sc.editNext': 'Zeile speichern — bei einer gerade angelegten die nächste öffnen',
  'sc.editNextRow': 'Zeile speichern und darunter eine neue öffnen',
  'sc.newRow': 'Neue Zeile darunter, bereit zum Tippen',
  ...
  'sc.ganttCursor': 'Cursor zwischen den Balken bewegen',
  'sc.ganttOpen': 'Eintrag unter dem Cursor öffnen',
  'sc.ganttReorder': 'Eintrag früher / später einordnen',
  'sc.ganttReorderEnds': 'Ganz nach vorne / hinten unter den Geschwistern',
  'sc.ganttSelectAll': 'Alle sichtbaren Balken auswählen',
  'sc.ganttClear': 'Auswahl aufheben, Ziehen abbrechen',
  'sc.orderEnds': 'Erste / letzte Zeile dieser Reihenfolge', 'sc.orderMove': 'In der Reihenfolge früher / später (ganze Auswahl)', 'sc.orderMoveEnds': 'An den Anfang / das Ende der Reihenfolge', 'sc.orderClear': 'Auswahl aufheben', 'sc.orderSelectAll': 'Die ganze Reihenfolge dieser Person auswählen',
  'sc.dialogTab': 'Zu Tab 1–7 wechseln, von überall im Dialog', 'sc.dialogTabBar': 'Vorheriger / nächster Tab (auf der Tab-Leiste; Pos1 / Ende für die Enden)', 'sc.dialogSections': 'Durch die Insights-Abschnitte und Links gehen; Enter öffnet den markierten', 'sc.dialogSave': 'Speichern und schließen', 'sc.dialogClose': 'Schließen (fragt nach, wenn etwas geändert wurde)',
  ...
  'tv.editSave': 'Zeile speichern',
  'tv.editCancel': 'Änderungen verwerfen',
  ...
  'ob.feat.metro': 'U-Bahn-Roadmap', 'ob.feat.metro.desc': 'Ein Projekt je Linie, Meilensteine als Haltestellen',
  'ob.feat.horizons': '3 Horizonte', 'ob.feat.horizons.desc': 'Committed, estimated, exploratory Planungsfenster',
  'ob.feat.cp': 'Kritischer Pfad', 'ob.feat.cp.desc': 'CPM-Analyse: welche Aufgabenkette das Enddatum bestimmt',
  ...
  'ob.feat.tree.htip': '**Arbeitspakete**\nHierarchischer Projektstrukturplan mit **verschachtelten Items, Abhängigkeiten und Mehrfachzuweisungen**.\nDrag & Drop zum Sortieren, Shift-Klick für Mehrfachauswahl, Rechtsklick für Kontextaktionen.',
  'ob.feat.auto.htip': '**Auto-Planung**\nPlanr führt einen **personenbezogenen Parallelplaner** aus — jede Person arbeitet ihre Warteschlange nach Priorität ab, unter Berücksichtigung von Kapazität und Urlaub.\nKeine manuellen Datumseingaben: Schätzungen oder Prioritäten ändern und der Plan aktualisiert sich sofort.',
  'ob.feat.metro.htip': '**U-Bahn-Roadmap**\nJedes Projekt wird zur **U-Bahn-Linie**. Meilensteine sind Haltestellen, der Zug zeigt den Echtzeit-Fortschritt.\nHover über Haltestellen für Termine und Status — eine Statusseite auf einen Blick für Stakeholder.',
  'ob.feat.horizons.htip': '**3 Planungshorizonte**\n**H1 Verbindlich** · startet bald, vollständig definiert.\n**H2 Geschätzt** · kommt danach, grob geplant.\n**H3 Explorativ** · liegt weiter draußen, bewusst offen gehalten.',
  'ob.feat.cp.htip': '**Kritischer Pfad**\nPlanr führt eine **CPM-Analyse** über den gesamten Arbeitsbaum durch und hebt die Aufgabenkette hervor, die direkt das Enddatum bestimmt.\nRote Balken = kritischer Pfad. Kürzen oder Personen hinzufügen, um das Projekt zu beschleunigen.',
  'ob.feat.net.htip': '**Netzwerkgraph**\nEine **zoom- und schwenkbare Abhängigkeitskarte** des gesamten Projekts.\nNode anklicken zum Bearbeiten, vom Rand ziehen um Abhängigkeiten zu erstellen. Gefiltert durch dieselben Root-/Team-/Personen-Filter wie andere Ansichten.',
  'ob.feat.focus.htip': '**Fokus-Bereiche**\n**Ziele, Painpoints und Deadlines** mit Arbeitspaketen verknüpfen für Top-down-Planung.\nDie Übersicht zeigt, welche Fokus-Bereiche gefährdet sind und wie viel Arbeit an jedes Ziel geknüpft ist.',
  'ob.feat.offboard': 'Offboard-Cascade', 'ob.feat.offboard.desc': 'Mid-task Personalwechsel automatisch',
  'ob.feat.offboard.htip': '**Offboard-Cascade**\nScheduler erkennt End-Datum einer Ressource mitten in einem Task und übergibt die Restarbeit automatisch an nächst-freies Team-Mitglied — optional cross-team. Jede Etappe (Offcut) wird eigene Gantt-Row + Handoff-Plan pro Etappe manuell übersteuerbar.',
  'ob.feat.cap': 'Kapazität aus Meetings', 'ob.feat.cap.desc': 'Kapazität aus Wochenstunden minus Meetings, statt geschätzter Prozentwerte',
  'ob.feat.cap.htip': '**Transparente Kapazität**\nCap ergibt sich aus Wochenstunden minus wiederkehrende Meetings (daily/weekly/biweekly/monthly). Team-Meeting-Pläne werden an alle Mitglieder vererbt — egal ob manuell oder derived. Jede Minute ist nachvollziehbar.',
  'ob.feat.export': 'Export für Management', 'ob.feat.export.desc': 'PDF + DOCX mit Subway-Chart, Critical Path, Risk-Report',
  'ob.feat.export.htip': '**Shareable PDFs + DOCX**\nManagement-Summary als echtes vektorgrafik-PDF mit Kennzahlen, Subway-Roadmap, Critical Path, Team-Capacity, Risikoliste. Zusätzlich Gantt-PDF (hochauflösend), Was-kommt-wann (horizontgerecht), TODO-Sprint je Person, Word-Export für Confluence-Import.',
  'ob.feat.offline': 'Offline + File-Mount', 'ob.feat.offline.desc': 'Kein Backend, kein Login; Daten liegen lokal oder in einer gemounteten Datei',
  'ob.feat.offline.htip': '**Lokal & offline**\nAlle Daten liegen lokal oder in einer gemounteten .md/.json-Datei. File System Access API → kein Copy-Paste-Workflow, automatisches Speichern. Keine Cloud-Abhängigkeit.',
  ...
  'app.save.autoToggleOn': 'Auto-Save ist AN — schreibt {0}s nach der letzten Änderung in die Datei. Speichern-Button für sofort.',
  'app.save.autoToggleOff': 'Auto-Save ist AUS — Änderungen landen nur im localStorage. Speichern-Button oder Ctrl+S schreibt in die Datei.',
  ...
  'app.save.pillAutoOff': 'Auto-Save ist aus. Speichern-Button oder Ctrl/Cmd+S schreibt in die Datei.',
  ...
  'app.save.pillPending': 'Änderungen liegen im localStorage und werden {0}s nach der letzten Änderung in die Datei geschrieben. Ctrl/Cmd+S oder der Speichern-Button schreibt sofort.',
  ...
  // ── Tour-Schritte ──
  'tour.s0.icon': 'subtask', 'tour.s0.title': 'Arbeitspakete',
  ...
  'tour.s1.icon': 'calendar', 'tour.s1.title': 'Automatische Planung',
  ...
  'tour.s2.icon': 'plus', 'tour.s2.title': 'Erste Aufgabe anlegen',
  ...
  'tour.s3.icon': 'gantt', 'tour.s3.title': 'Fortschritt verfolgen',
