...
const en = {
  ...
  'sc.orderEnds': 'First / last row of this person\u2019s queue', 'sc.orderMove': 'Move earlier / later in the queue (the whole selection)', 'sc.orderMoveEnds': 'Move to the front / end of the queue', 'sc.orderClear': 'Clear the selection',
...
const de = {
  ...
  'sc.orderEnds': 'Erste / letzte Zeile dieser Reihenfolge', 'sc.orderMove': 'In der Reihenfolge früher / später (ganze Auswahl)', 'sc.orderMoveEnds': 'An den Anfang / das Ende der Reihenfolge', 'sc.orderClear': 'Auswahl aufheben',
