...
const en = {
  ...
  'rm.today': 'today',
  'rm.zoomInTip': 'Zoom in — Ctrl/Cmd + mouse wheel works too, and a zoomed map scrolls',
...
const de = {
  ...
  'rm.today': 'heute',
  'rm.zoomInTip': 'Vergrößern — geht auch mit Strg/Cmd + Mausrad; eine vergrößerte Karte lässt sich scrollen',
