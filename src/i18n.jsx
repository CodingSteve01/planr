...
const en = {
  ...
  'wo.help': 'Each person\u2019s tasks in scheduled order. Space cycles status, 1–4 sets priority, S M L X sets size, E or a double-click opens the editor. Reordering here can pull a task ahead of another project\u2019s; dependencies and pinned dates still take precedence.',
...
const de = {
  ...
  'wo.help': 'Die Aufgaben jeder Person in geplanter Reihenfolge. Leertaste schaltet den Status, 1–4 setzt die Priorität, S M L X die Größe, E oder Doppelklick öffnet den Editor. Umsortieren kann eine Aufgabe vor die eines anderen Projekts ziehen; Abhängigkeiten und feste Termine gehen weiterhin vor.',
