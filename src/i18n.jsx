...
const en = {
  ...
  'bd.help': 'Dates structural edits in the past so they do not appear as progress in the next review. Status and progress changes are unaffected and keep the date they were made.',
...
const de = {
  ...
  'bd.command': 'Änderungen rückdatieren…',
  ...
  'bd.help': 'Datiert Strukturänderungen in die Vergangenheit, damit sie im nächsten Review nicht als Fortschritt erscheinen. Status- und Fortschrittsänderungen bleiben davon unberührt und behalten ihr Datum.',
  'bd.date': 'Wirksam zum',
